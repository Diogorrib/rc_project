...
/// @brief Send buffer to AS and receive msg_received 
/// from AS using UDP, if return is -1 the connection 
/// to AS went wrong
...
/// AS using TCP, if return is -1 the connection to AS went wrong.
...
/// @brief Return 1 if there is no uid or password else return 0
