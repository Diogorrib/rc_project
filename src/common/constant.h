...
#define BID (UID+MAX_4_LONG+DATE_TIME+MAX_4_SOME_INTS+6)   // including the next space (B bidder_UID bid_value bid_date-time bid_sec_time)

#define LOGIN_SND (CMD_N_SPACE+UID+PASSWORD+3) // size of message sent to AS including the '\0' (ex.: LIN UID password)
#define OPEN_SND (CMD_N_SPACE+UID+PASSWORD+NAME+2*MAX_4_SOME_INTS+FNAME+MAX_4_LONG+8) // size of a part of the message sent to AS including the '\0' (OPA UID password name start_value timeactive Fname Fsize ...)
...
#define BID_SND (CMD_N_SPACE+UID+PASSWORD+AID+MAX_4_LONG+5) // size of the message sent to AS including the '\0' (BID UID password AID value)
...
#define SR_PRINT (NAME+FNAME+UID+MAX_4_SOME_INTS+DATE_TIME+MAX_4_SOME_INTS+MAX_BIDS*(MAX_4_SOME_INTS+MAX_4_LONG+DATE_TIME+MAX_4_SOME_INTS+59)+71+32+1) // worst case for show record print including '\0'
